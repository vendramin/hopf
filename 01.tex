...
\label{exa:dual_algebra}
    ...
    coalgebra $A^*$ is called the \emph{dual coalgebra} of $A$. In Sweedler's notation,
    \[
      (f_1\otimes f_2)(a\otimes b)=\Delta(f)(a\otimes b)=f(ab).
    \]
\end{example}
